...
//    private final static String VIDEO_CACHE_DIR = "/video_cache";
    ...
    public static File getRxCacheDir(Context context) {
        return getCacheDir(context, RX_CACHE_DIR);
    }
    ...
    public static File getGlideDiskCacheDir(Context context) {
        return getCacheDir(context, GLIDE_DIS_CACHE_DIR);
    }
    ...
    private static File getCacheDir(Context context, String cachedir) {
        String path = RxFileTool.getDiskCacheDir(context) + cachedir;
