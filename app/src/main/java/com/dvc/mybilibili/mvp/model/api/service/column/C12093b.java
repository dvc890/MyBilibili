...
public interface C12093b {
    ...
    Observable<GeneralResponse<BaseListItemsData<ColumnFavorite>>> getColumnFavoriteList(@Query("access_key") String str, @Query("pn") int i, @Query("ps") int i2);
    ...
    Observable<GeneralResponse<ColumnFeedList>> getUpperArticle(@Query("access_key") String str, @Query("pn") int i, @Query("ps") int i2);
}
